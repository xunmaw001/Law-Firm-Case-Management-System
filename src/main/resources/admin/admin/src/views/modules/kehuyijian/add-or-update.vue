    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="意见内容" prop="kehuyijianText">
                        <el-input type="textarea"  :readonly="ro.kehuyijianText" v-model="ruleForm.kehuyijianText" placeholder="意见内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kehuyijianText" label="意见内容" prop="kehuyijianText">
                            <span v-html="ruleForm.kehuyijianText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`kehuyijian/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kehuyijianCrossAddOrUpdateFlag = false;
                                        this.parent.search();
