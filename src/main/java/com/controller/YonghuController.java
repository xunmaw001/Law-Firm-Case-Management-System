...
//                            yonghuEntity.setYonghuName(data.get(0));                    //客户名称 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //客户手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //客户身份证号 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "客户");
        R r = R.ok();
        r.put("token", token);
        r.put("role","客户");
